...
Checkpoint 335 is the current boundary. Research 120 remains qualified and closed for the accepted PDF direct-source routing scope, while Research 121 governs the Office whole-file handoff work. AB-020 remains live-qualified and closed for its concrete tracked-path enumeration defect. The first ordinary-host preview.17 `-Publish` attempt stopped safely during preflight because one AB-020 regression encountered a Windows `EBUSY` while deleting its temporary Git fixture. Independent inspection proved zero live preview.17 mutation: all six existing package targets still matched preview.16, the three new Office files remained absent, the live semantic-Git hash stayed unchanged, and the running surface remained preview.16 / 60 tools. The regression harness was hardened only at temporary cleanup by adding bounded retries to the six one-shot fixture removals, then committed/pushed privately at `386813d1a31afd6748ad829c2f1dab3ea1bb89f4`. The publication helper is rebound to that head, hashes to `b2e73646922851682c855739eecb539ef73e7d3fc75e278967e66a4829b44ba9`, and has passed two consecutive complete no-publish preflights. The exact next action is retrying ordinary-host preview.17 publication, then independent installed-hash verification, controlled restart, and fresh ChatGPT discovery before the DOCX/PPTX/XLSX host fidelity matrix.
