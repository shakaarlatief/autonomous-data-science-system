# BL-003 Request: Broad Project Orientation
...
I have lost the broader project context. Before we do anything else, reconstruct a broad orientation of the project for me. Explain the major enduring domains/workstreams you can establish from the repository and point me to the most important governing or deep sources for each. Do not assume that I remember filenames, document numbers or the previous conversation.

I want useful broad understanding, not just the immediate current task and not a dump of every file.
