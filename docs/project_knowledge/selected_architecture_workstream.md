...
<!-- PKA-STRUCTURED-DECLARATION-BEGIN -->
{
  ...
  "execution_anchor": {
    ...
    "pull_request": null,
    "current_boundary": "project-knowledge-architecture-evolution-governance-design"
  },
  "stage": {
