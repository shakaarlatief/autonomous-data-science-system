...
**Thread:** MC-0029
**Status:** OPEN / KEY-A P3 BATCH 4 PASS / BATCH 5 OWNER CONTINUE NEXT
...
## Sequence
    ...
    Key A P3 BIRTH held-out classification       BATCHES 1-4 PASS / PRIVATE FROZEN / BATCH 5 TASK-OWNER RELEASED
...
Claude may write only:
    ...
    MC0029=OPEN
    PHASE=DRP03_R2_KEY_AUTHOR_A_P3_BATCH5_OWNER_CONTINUE_NEXT
    ...
    KEY_A_P3_BATCH5=TASK_OWNER_RELEASED
    KEY_A_P3_BATCHES_6_13=AUTHORIZED_IN_PRINCIPLE_TASK_OWNER_GATED
