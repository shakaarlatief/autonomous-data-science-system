...
**Thread:** MC-0029
**Status:** OPEN / KEY-A P3 BATCH 3 PASS / BATCH 4 OWNER CONTINUE NEXT
...
## Sequence
    ...
    Key A P3 BIRTH held-out classification       BATCHES 1-3 PASS / PRIVATE FROZEN / BATCH 4 TASK-OWNER RELEASED
...
Claude may write only:
    ...
    MC0029=OPEN
    PHASE=DRP03_R2_KEY_AUTHOR_A_P3_BATCH4_OWNER_CONTINUE_NEXT
    ...
    KEY_A_P3_BATCH4=TASK_OWNER_RELEASED
    KEY_A_P3_BATCHES_5_13=AUTHORIZED_IN_PRINCIPLE_TASK_OWNER_GATED
