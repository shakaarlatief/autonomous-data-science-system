...
**Thread:** MC-0029
**Status:** OPEN / KEY-A P3 BATCH 6 PASS / BATCH 7 OWNER CONTINUE NEXT
...
## Sequence
    ...
    Key A P3 BIRTH held-out classification       BATCHES 1-6 PASS / PRIVATE FROZEN / BATCH 7 TASK-OWNER RELEASED
...
Claude may write only:
    ...
    MC0029=OPEN
    PHASE=DRP03_R2_KEY_AUTHOR_A_P3_BATCH7_OWNER_CONTINUE_NEXT
    ...
    KEY_A_P3_BATCH7=TASK_OWNER_RELEASED
    KEY_A_P3_BATCHES_8_13=AUTHORIZED_IN_PRINCIPLE_TASK_OWNER_GATED
