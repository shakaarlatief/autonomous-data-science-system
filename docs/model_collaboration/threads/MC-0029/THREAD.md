...
**Thread:** MC-0029
**Status:** OPEN / KEY-A P3 BATCH 8 PASS / BATCH 9 OWNER CONTINUE NEXT
...
## Sequence
    ...
    Key A P3 BIRTH held-out classification       BATCHES 1-8 PASS / PRIVATE FROZEN / BATCH 9 TASK-OWNER RELEASED
...
Claude may write only:
    ...
    MC0029=OPEN
    PHASE=DRP03_R2_KEY_AUTHOR_A_P3_BATCH9_OWNER_CONTINUE_NEXT
    ...
    KEY_A_P3_BATCH9=TASK_OWNER_RELEASED
