...
**Thread:** MC-0029
**Status:** OPEN / KEY-A P3 BATCH 9 HOLD / FRESH REPLACEMENT OWNER LAUNCH NEXT
...
## Sequence
    ...
    Key A P3 BIRTH held-out classification       BATCHES 1-8 PASS / BATCH 9 HOLD / FRESH REPLACEMENT AUTHORIZED
...
Claude may write only:
    ...
    MC0029=OPEN
    PHASE=DRP03_R2_KEY_AUTHOR_A_P3_BATCH9_HOLD_FRESH_REPLACEMENT_NEXT
    ...
    KEY_A_P3_BATCH9=HOLD_OPEN_BATCH_COMPACTION
    KEY_A_P3_BATCH9_REPLACEMENT=TASK_OWNER_AUTHORIZED
    KEY_A_P3_BATCHES_10_13=AUTHORIZED_IN_PRINCIPLE_TASK_OWNER_GATED
