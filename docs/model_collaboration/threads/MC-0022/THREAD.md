...
ChatGPT remains task owner and target-state integrator. Claude must not mutate routing, current state, research, specifications, checkpoints, architecture docs, implementation, tests or generated views.
