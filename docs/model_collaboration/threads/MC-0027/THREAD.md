...
**Thread:** MC-0027
**Status:** OPEN / ATTEMPT 1 HARNESS_INVALID / REPAIRED HARNESS REFROZEN / ATTEMPT 2 NEXT
...
Claude may write only:
    ...
    MC0027=OPEN
    PHASE=CORRECTED_RERUN_REFROZEN
    ...
    REPLACEMENT_HARNESS_COMMIT=a893e7e904e29ca91491108bd816d4af06dba6c1
