...
from experiments.system_owned_provenance_recommendation_action_value.harness import JudgeResult
    ...
    async def judge(self, *, judge_id: str, payload: Mapping[str, object]) -> JudgeOutcome:
        ...
        agent = agents.Agent(
            ...
            instructions=(
                ...
                "evidence, action/scope/clarification/defer-trigger menus, candidate "
                "structured result, and frozen rubric. Do not infer which experimental "
                "condition produced the candidate. Exact benchmark dispositions and "
                "expected pointers are intentionally hidden and evaluated separately by "
